...
<div class="container">
    ...
    <div class="form row">
        <form class="form-horizontal col-md-offset-3" id="login_form" action="/admin/reg_check" method="post">
            ...
            <div class="col-md-9">
                ...
                <div class="form-group">
                    <i class="fa fa-lock fa-lg"></i>
                    <input class="form-control required" type="email" placeholder="Email" id="email" name="email" maxlength="20"/>
                </div>
