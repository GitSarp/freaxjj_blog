...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="/ie-view-bug/ie10-viewport-bug-workaround.css" rel="stylesheet">
...
<div class="pageContainer">
    ...
    <div class="pageSidebar">
        <ul class="nav nav-stacked nav-pills">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="/admin/blogmanage" target="mainFrame">文章管理</a>
                    </li>
                    <li>
                        <a href="nav2.html" target="mainFrame">标签管理</a>
                    </li>
                </ul>
            </li>
    ...
    <div class="pageContent">
        <iframe src="/admin/blogmanage" id="mainFrame" name="mainFrame"
...
<!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
<script src="/ie-view-bug/ie10-viewport-bug-workaround.js"></script>
